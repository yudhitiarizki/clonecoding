...
import imagerank from '../assets/images/misc/rank.png';
...
const Gambar2 = ({
  ...
  // Preparing Rank
  useEffect(() => {
    const rankimagetemp = new Image();
    rankimagetemp.src = imagerank
    rankimagetemp.onload = () => setRankImage(rankimagetemp)
  })
  ...
  useEffect(() => {
    ...
    if (pendulum === false) {
      backimagetemp.src = imagecardtype.imagecardtypemonster.xyz
    } else if (pendulum === true){
      backimagetemp.src = imagecardtype.imagecardtypemonster.xyzp  
    }
  ...
  useEffect(() => {
    if( canvas && image && backimage && attributeimage && rankimage && (pendulum === false || pendulum === "")) {
      ...
      // Rank
      while (iter < rank){
        ctx.drawImage(rankimage, 133+(iter*88), 255, 75, 75)
        iter++
      }
      // name font settings 
    ...
    } else if ( canvas && image && backimage && attributeimage && rankimage && pendulum === true){
      //////////////////////////////////////////////////////////////
      //////////////////////////////////////////////////////////////
      //////////////////////////////////////////////////////////////
      //////////////////////////////////////////////////////////////
